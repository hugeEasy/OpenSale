...
<!-- 			</table> -->
		...
		<!-- </table> -->
		 ...
		 <c:forEach items="${listCompanyBill}" var="companyBill">
		<p style="line-height: 30px;margin: 0;border-bottom: 1px solid #E2E2E2;font-size: 12px;">消费总额：<span style="float: right;">${companyBill.totalFee}元</span></p>
		
				<p style="line-height: 30px;margin: 0;border-bottom: 1px solid #E2E2E2;font-size: 12px;">公司余额：<span style="float: right;">
		${comanymoneymess }
				</span></p>
		
		<p style="line-height: 30px;margin: 0;border-bottom: 1px solid #E2E2E2;font-size: 12px;">待付款：<span style="float: right;">${companyBill.unsettlementFee}元</span></p>
		</c:forEach>
	</div>
