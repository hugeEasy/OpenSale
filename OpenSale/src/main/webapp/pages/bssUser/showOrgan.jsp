	...
	<tbody>
		...
		<tr>
			...
			<td class="center">
			  ...
			  <a href="javaScript:void(0);" class="btn btn-danger btn-xs delete deletePro" data-orgid="${project.orgid}" data-page="${paginator.page}" data-status="0">删除</a>
...
<jsp:include page="../common/paginator.jsp">
	<jsp:param value="filter/bssuser/showOrgan" name="url"/>
