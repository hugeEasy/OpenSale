...
<link rel="shortcut icon" href="plugin/img/logo20.png">
...
<body class="login-wrap">
	...
	<img src="img/bg.jpg">
			...
			<input type="hidden" name="organizeId" value="1" id="organizeId">
				...
				<div class="identity-out">
					...
					<!-- <div id="verifyCodeImg" > -->
					 <img id="kaptchaImage" style="display:none" src="login/getKaptchaImage" onclick="this.src='login/getKaptchaImage?e='+new Date()" id="identity" class="">
		...
		<div class="footer">Copyright © HugeDog有限公司. All Rights Reserved.</div>
