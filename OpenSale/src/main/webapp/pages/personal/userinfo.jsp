			...
			<div class="self-info-wrap">
				...
				<div>
					...
					<div>
						<label for="sex">性别</label>
						 <input type="text" id="sex"
							...
							<ul class="project_ul" id="project_ul" style="top:47px;width: 38%;left: 23%">
							    <li>男</li>
							    <li>女</li>
							</ul>
					</div>
					...
					<div class="input-group col-md-4 colLee" style="display:inline-block;">
						<a class="btn btn-info btn-userg" id="btn-userg">取消</a>
					</div>
				...
				<form class="user-form user-form2 user-password" id="userId" method="post" action="" style="padding-top: 10px;">
					...
					<div class="input-group col-md-4 colLee" style="display:inline-block;">
						<a class="btn btn-info" id="btn-userg btn-userg" style="background-color: #2AADFF">取消</a>
					</div>
