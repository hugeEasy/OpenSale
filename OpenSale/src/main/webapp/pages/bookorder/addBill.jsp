		...
		<div class="box-inner">
			...
			<div class="box-content" style="min-height: 320px;">
				<div id="addPdialog" style="">
					<form class="form-horizontal" id="bookinfo" style="margin-left: -75px;  ">
							...
							<div class="col-md-6">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" id="bookCount"
										name="bookCount" placeholder=""  maxlength=15
										<%-- onKeyPress="if (event.keyCode!=45  && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"  --%>  > <i
										class="glyphicon glyphicon-remove alert-cha" id="bocha"></i>
								</div>
							</div>
							<div class="col-md-6">
...
{{#each this}}
	<option class="proclass" value="{{productId}}" data-value="{{unitPrice}}" data-name="{{productName}}">{{productName}}</option>
{{/each}}
</script>
