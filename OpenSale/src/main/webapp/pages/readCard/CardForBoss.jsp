...
<form class="form-horizontal clearfix" id="forCardId">
						...
						<div class="forms-groups clearfix">
							<div>
								<p>手机号：</p>
								<input type="text" class="form-control input-md" id="phoneNum" placeholder="手机号" onblur="onblus()">
							</div>
							<div>
								<p>密码：</p>
								<input type="text" class="form-control input-md" id="passwd" placeholder="密码">
							</div>
