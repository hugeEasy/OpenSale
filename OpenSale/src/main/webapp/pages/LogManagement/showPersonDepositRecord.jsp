			...
			<div class="box-content" style="min-height: 320px;">
				<div>
					<form action="" id="recordfrom">
						...
						<input hidden="true" id="isCom" name="isCom" value="1"> <input
							hidden="true" id="companyName" name="companyName">
						<div class="input-group col-md-3"
							style="margin: 2px 0; display: inline-table;">
							<span class="input-group-addon">会员姓名</span> <input type="text"
								class="form-control" placeholder="会员姓名" id="userName"
								name="userName">
						</div>
						<div class="input-group col-md-3"
							style="margin: 2px 0; display: inline-table;">
							<span class="input-group-addon">交易类型</span> <select id="type"
								name="type" class="form-control" type="select" value="1">
						...
						<div class="input-group col-md-3"
							...
							<span class="input-group-addon">会员手机号</span> <input type="text"
								class="form-control" placeholder="会员手机号" id="userPhone"
								name="userPhone">
						</div>
						<div class="input-group col-md-3"
							style="margin: 2px 0; display: inline-table;">
							<span class="input-group-addon">起始时间</span> <input type="text"
								class="form-control reDatetimepicker" id="startTime"
								name="fromTime" readonly="readonly" />
						</div>
						<div class="input-group col-md-3"
							style="margin: 2px 0; display: inline-table;">
							<span class="input-group-addon">结束时间</span> <input type="text"
								class="form-control reDatetimepicker" id="endTime" name="toTime"
								readonly="readonly" />
						</div>
						<div class="input-group col-md-3"
							style="margin: 2px 0; display: inline-table;">
						...
						<div class="input-group col-md-3"
							style="margin: 2px 0; display: inline-table;">
							<span class="input-group-addon">渠道</span> <select id="channel"
								name="payWay" class="form-control" type="select"
								value="${payWay}">
							...
							$("#channel").append("<option value="${pag.typeNum}">${pag.typeValue}</option>");
								...
								<c:if test="${channel!=null&&channel!=''}">
          						...
          						$("#channel").append("<option value="${pag.typeNum}"
													id="${pag.typeNum}">${pag.typeValue}</option>");
          				</c:if>
										</c:forEach>
										<c:forEach items="${paginator2}" var="pag">
											<c:if test="${channel!=pag.typeNum}">
