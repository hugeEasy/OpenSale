...
<%-- <a id="comDetails" class="btn btn-primary" onclick="comDetails('${os.companyId}')">详情</a> --%>
		...
		<input type="button" id="comDetails" class="btn  btn-primary " value="公司成员" onclick="memSearch('${os.companyId}')">
				<input type="button" id="comArea" class="btn  btn-primary " value="公司场地" onclick="companyArea('${os.companyId}','${os.companyName }')">
