...
$("#formcheck_sure").on("click",function(){
	...
	if(judge){
		var text=confirm("             公司名称："+companyName+String.fromCharCode(10)+
				"             会员帐号： "+phone+String.fromCharCode(10)+
				"             产品类型： "+assetType+String.fromCharCode(10)+
				"              产    品  ： "+productId+String.fromCharCode(10)+
				"              数    量  ： "+bookCount+String.fromCharCode(10)+
				"             生效时间： "+effectTime+String.fromCharCode(10)+
				"             失效时间： "+lapsedTime+String.fromCharCode(10)+
				"             结清状态： "+statusName+String.fromCharCode(10)+
